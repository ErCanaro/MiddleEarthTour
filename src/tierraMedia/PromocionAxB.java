...
public class PromocionAxB extends Producto {
	...
	public PromocionAxB(String nombre, TipoAtraccion tipo, Atraccion a1, Atraccion a2, Atraccion a3) {
		super(nombre, tipo, 0);
//		int aux = 0;
//				if (Math.min(a1.getCupo(), a2.getCupo()) <= a3.getCupo()) {
//					aux = Math.min(a1.getCupo(), a2.getCupo());	
//				} else {
//					aux = a3.getCupo();
//				}
...
//		this.setCupo(aux);
	...
	public String toString() {
		return "[Promocion: "+ super.getTipo()+ "]"+"'"+super.getNombre() + "', Costo: " + super.getCosto()+" Duracion: " + super.getDuracion()+ ".\n" 
		       ...
		       + atraccionesIncluidas.get(1).getNombre() + ", "+ atraccionesIncluidas.get(2).getNombre();
	}
